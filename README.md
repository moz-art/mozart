...
~~~sh
# getting the code
git clone git@github.com:nko4/mozart.git && cd ./mozart/

# developing
npm install
npm start

# deploying (to http://mozart.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@mozart.2013.nodeknockout.com
ssh root@mozart.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@mozart.2013.nodeknockout.com
ssh -i ./id_deploy root@mozart.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/mozart" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
